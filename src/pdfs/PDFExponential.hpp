...
#ifndef PDFEXPONENTIAL_HPP
#define PDFEXPONENTIAL_HPP
...
namespace pdfs {
     ...
     */
    class PDFExponential : public PDFSegment {
    public:

        // Constructor and destructor
        /**
         * @brief Constructor for PDFExponential.
         ...
         */
        PDFExponential(double sMin, double sMax, double scale, rngType &rng) : 
        ...
        ~PDFExponential() override = default;
