...
/**
 * @brief Unit test for phot::PhotConvert
 ...
 * roundoff.
 */
inline auto testPhotConvert() -> int
{
    ...
    if (relErrFnu > relTol)
    {
        std::cerr << "testPhotConvert: Flambda -> Fnu gave " << fnu
    ...
    {
        std::cerr << "testPhotConvert: Fnu -> Flambda round trip gave "
